...
class SGD:
    def __init__(self, lr=0.01):
        self.lr = lr  # learning rate (학습률), 인스턴스 변수로 유지한다.

    def update(self, params, grads):   # 반복해서 불림. params와  grads는 딕셔너리 변수.
        for key in params.keys():       # 각각 가중치 매개변수와 기울기를 저장하고 있다.
...
# 6.1.4 모멘텀
"""
모멘텀Momentum : 물리에서의 운동량 , 그레이디언트에 스무딩을 가해 잡음효과를 줄인다.
v ← αv - η * ∂L/∂W
W ← W + v
